...
namespace Gothic_II_Addon {
  ...
  public:
    ...
    int WriteBool( zSTRING const&, char const*, int, int val = 0)                             zCall( 0x00461DE0 );
    int WriteInt( zSTRING const&, char const*, int, int val = 0)                              zCall( 0x00461E30 );
    int WriteDWord( zSTRING const&, char const*, unsigned long, int val = 0)                  zCall( 0x00461E60 );
    int WriteReal( zSTRING const&, char const*, float, int val = 0)                           zCall( 0x00461F90 );
    int WriteString( zSTRING const&, char const*, zSTRING, int val = 0)                       zCall( 0x00461FD0 );
    int ReadBool( zSTRING const&, char const*, int default_val = 0)                           zCall( 0x00462160 );
    int ReadInt( zSTRING const&, char const*, int default_val = 0)                            zCall( 0x00462390 );
    ...
    zSTRING ReadString( zSTRING const&, char const*, char const* default_val = 0)             zCall( 0x004627E0 );
