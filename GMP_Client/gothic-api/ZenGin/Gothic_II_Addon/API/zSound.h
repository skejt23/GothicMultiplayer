...
namespace Gothic_II_Addon {
  ...
  public:
    ...
    virtual int PlaySound3D( zCSoundFX*, zCVob*, int, zTSound3DParams* = nullptr)     zPureCall;
    virtual int PlaySound3D( zSTRING const&, zCVob*, int, zTSound3DParams* = nullptr) zPureCall;
